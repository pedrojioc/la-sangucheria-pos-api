...
export class InventoryLevelEntity {
  ...
  @Column({ name: 'current_quantity', type: 'decimal', precision: 12, scale: 4, default: 0 })
  currentQuantity: number

  @Column({ name: 'unit_id', type: 'uuid' })
  unitId: string

  @Column({ name: 'minimum_quantity', type: 'decimal', precision: 12, scale: 4, default: 0 })
  minimumQuantity: number

  @Column({ name: 'maximum_quantity', type: 'decimal', precision: 12, scale: 4, nullable: true })
  maximumQuantity: number | null

  @Column({ name: 'reorder_point', type: 'decimal', precision: 12, scale: 4, nullable: true })
