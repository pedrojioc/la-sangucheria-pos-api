import { ProductPriceChangedEvent, ProductPriceChangedPayload } from '@contexts/menu/product/domain/events/product-price-changed.event'
...
describe('ProductPriceChangedEvent', () => {
  ...
  describe('serialization roundtrip', () => {
    it('should maintain data integrity through serialization and deserialization', () => {
      ...
      expect(reconstructedEvent.payload.priceChangePercentage).toBe(originalPayload.priceChangePercentage)
      expect(reconstructedEvent.payload.changedAt.toISOString()).toBe(originalPayload.changedAt.toISOString())
