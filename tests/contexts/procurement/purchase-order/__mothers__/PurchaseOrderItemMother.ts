import { PurchaseOrderItem, PurchaseOrderItemPrimitives } from '@/contexts/procurement/purchase-order/domain/purchase-order-item'
...
export class PurchaseOrderItemMother {
  ...
  static createPrimitive(params: Partial<{
    id: string
    ingredientId: string
