...
- **Global scope**: `/Users/pedro/Projects/Avanza/lasangucheria-pos/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/pedro/Projects/Avanza/lasangucheria-pos/.claude/notes/`)
...
2. Glob `/Users/pedro/Projects/Avanza/lasangucheria-pos/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/pedro/Projects/Avanza/lasangucheria-pos/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/pedro/Projects/Avanza/lasangucheria-pos/.claude/notes/` — works in any directory
