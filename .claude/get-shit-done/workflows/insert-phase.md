...
```bash
INIT=$(node "/Users/pedro/Projects/Avanza/lasangucheria-pos/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/pedro/Projects/Avanza/lasangucheria-pos/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
